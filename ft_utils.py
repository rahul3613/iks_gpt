...
def add_noise(text, noise_add_prob=0.3, char_shuff_prob=0.01, word_drop_prob=0.02, char_repl_prob=0.01, char_move_prob=0.01, space_repl_prob=0.01):
...
def get_val_ids(data_path="../ft_val_data/"):
    with open(f"{data_path}verse/sampled_ids.json", "r") as f:
        verse_ids = json.load(f)
